...
;(function () {
    ...
    function __createUqIndex() {
        __uqIndex++;
        return __uqIndex.toString(16);
    }
    ...
    var Slim = function (_CustomElement2) {
        ...
        _createClass(Slim, [{
            ...
            key: '_bind',
            value: function _bind(descriptor) {
                descriptor.properties.forEach(function (prop) {
                    ...
                    var newSetter = function newSetter(x) {
                        ...
                        this._propertyChanged(rootProp, x);
                    };
            ...
            value: function _initInteractiveEvents() {
                ...
                if (!this.__eventsInitialized && (Slim.autoAttachInteractionEvents || this.isInteractive || this.hasAttribute('interactive'))) Slim._nativeEvents.forEach(function (eventType) {
                ...
                var _loop = function _loop(child) {
                    ...
                    if (child.attributes) {
                        var _loop3 = function (i) {
                            var isNativeEventAttribute = Slim._nativeEvents.indexOf(child.attributes[i].nodeName >= 0) || Slim._nativeEvents.some(nativeEventName => 'on' + nativeEventName === child.attributes[i].nodeName);
                            if (!child.isSlim && !child.__eventsInitialized && isNativeEventAttribute) {
        ...
        var SlimRepeater = function (_Slim) {
            ...
            _createClass(SlimRepeater, [{
                ...
                value: function createItems(sourceData) {
                    ...
                    var _loop4 = function _loop4(clone) {
